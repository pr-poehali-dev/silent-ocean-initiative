...
const faqs = [
  ...
  {
    question: "Вы работаете только на Камчатке?",
    answer:
      "Мы базируемся на Камчатке, но организуем мероприятия по всей России и за рубежом. Выездные свадьбы, корпоративы на природе, события в других городах — наша команда готова к любой географии.",
  },
  {
